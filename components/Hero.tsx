    ...
    >
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          <span style={{ color: "var(--color-honey)" }}>una vida plena</span>
          <br />
          para sus hijos 🐝
        </motion.h1>
        ...
        >
          Atención integral con amor, dedicación y 29 años de experiencia.
          Tres sedes en Medellín para acompañar cada etapa de su pequeño.
        </motion.p>
        ...
        >
          <a // CORRECCIÓN: Faltaba el inicio de la etiqueta <a>
            href="#contacto"
            style={{
